        ...
        <div className="right-description">
          <div className="right-content">
            ...
            <section>
              ...
              regardless of the amount of assignments, quizzes or exams per
              week.
            </section>

            <header>Exams</header>
            <section>
              We charge $100-$360 per exam, please chat with support to get the
              exact quote. We do proctored exams.
            </section>
          </div>
        </div>
