...
import { RiDashboardLine,RiUserHeartLine,FaUsersCog,RiFileList3Fill } from 'react-icons/all'
    ...
    return(
        <nav className={isDashboardVisible}>
            ...
            <ul className="nav-list">
                ...
                <li><Link to={"/orders"}  className="links"><RiFileList3Fill/> Orders</Link></li>
