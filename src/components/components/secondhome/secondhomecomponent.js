...
function Secondhomecomponent(){
    ...
    return(
        ...
        <header>Essay<span style={{color:' #F4D140'}}>help</span> A grade services</header>
        <section>Our platform is generated for quick and simple fixes as well as long-term guidance. As a top paper writing service, we work with sophisticated and complex requests alongside simple ones. We are very experienced in working with a multitude of academic tasks; this includes admission assignments, research papers, term papers, etc. Also, our company is a reliable consultation dissertation writing service..</section>
        <section>Our team understands the importance of the content we present. That is why we take it upon ourselves to implement legitimacy within the work we provide. Moreover, our website blog includes free writing tips and tutorials to help potential clients as well as for students who just need academic guidance.</section>
            </div>
            </div>
            <div className="guarantee">
                <h1>Our 100% guarantee plan</h1>
            </div>            
